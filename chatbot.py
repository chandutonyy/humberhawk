...
base_model = AutoModelForSeq2SeqLM.from_pretrained(
    checkpoint,
    device_map="auto",
    torch_dtype = torch.float32,offload_folder="save_folder"
)
...
def main():
    st.markdown("<h1 style='text-align: center; color: blue;'>Humber Chatbot </h1>", unsafe_allow_html=True)
